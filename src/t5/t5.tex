...
% \newcommand{\boss}[1]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{#1}}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra Practice}}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra} - Case 1}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra} - Case 1}
	...
	(3)  Yes it is 2NF, 3NF, but not BCNF (e.g., $\{W\} \rightarrow \{M\}$).\\\vspace{5pt}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra} - Case 2}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra} - Case 3}
...
\begin{frame}[fragile]{\scalerel*{\includegraphics{t5/images/boss_level.png}}{boss\_icon}~\textcolor{red}{Boss Level Extra} - Case 4}
	This time we deal with abstract relations with functional dependencies shown as in the figure below:\\\vspace{-5pt}
